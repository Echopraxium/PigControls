...
# pig_color_select.gd
#-------------------------------------------------------------------------------------
# Description: 'PigColorSelect' control class
...
# This class is a subcass of 'PigletColorSelect'
extends "res://addons/pig_controls/Buttons/ColorSelect/piglet_color_select.gd"
...
#----------------------------------------------------------------------------------------
func _getIconPath():
    return "res://addons/pig_controls/Buttons/ColorSelect/pig_color_select.png"
